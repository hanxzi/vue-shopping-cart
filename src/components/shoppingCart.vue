    ...
    <div id="app">
                ...
                <li v-for="(item,index) in productList">
                  ...
                  <div class="cart-tab-5">
                    <div class="cart-item-operation">
                      <a href="javascript:void 0" class="item-edit-btn" v-on:click="delConfirm(item)">
            ...
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascript:void 0">
                  <span class="item-check-btn" :class="{'check':checkAllFlag}" v-on:click="checkAll(true)">
                      <svg class="icon icon-ok"><use xlink:href="#icon-ok"></use></svg>
                    </span>
                  <span>全选</span>
                </a>
              ...
              <div class="item-all-del">
                <a href="javascript:void 0" class="item-del-btn" v-on:click="checkAll(false)">
                  <span>取消全选</span>
                </a>
              </div>
            </div>
      ...
      <div class="md-modal modal-msg md-modal-transition" id="showModal" v-bind:class="{'md-show':delFlag}">
        <div class="md-modal-inner">
          <div class="md-top">
            <button class="md-close" v-on:click="delFlag=false">关闭</button>
          </div>
          <div class="md-content">
            ...
            <div class="btn-wrap col-2">
              ...
              <button class="btn btn--m btn--red" id="btnModalCancel" v-on:click="delFlag=false">No</button>
            </div>
          </div>
        </div>
      </div>
